...
ggplot(stats_DNA, aes(x = timepoint, y = `Read length N50:`, fill = timepoint)) +
	geom_col() +
...
ggplot(stats_DNA, aes(x = timepoint, y = `Number of reads:`, fill = timepoint)) +
	geom_col() +
...
```{bash get readlengths, echo = FALSE, eval = FALSE}
# For each sample
